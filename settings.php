...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['change_email'])) {
        ...
        if (password_verify($current_password, $user['password_hash'])) {
            ...
            $error = "Password saat ini salah. Perubahan email ditolak.";
        }
...
<head>
    ...
    <title>MotoTrack Pro | Account Settings</title>
        ...
        <div class="bg-white border border-slate-200 rounded-xl p-8 mb-8 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <span class="px-3 py-1 bg-slate-100 text-slate-700 rounded-full text-xs font-bold uppercase inline-block">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-8 shadow-sm">
                ...
                <form method="POST" action="settings.php" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-1">Current Password <span class="text-xs font-normal text-slate-400">(for security)</span></label>
